...
public class ElasticSearchConsumer {
    ...
    public static RestHighLevelClient createClient(){
        ...
        String hostname = "vivek-kafka-elastic-8700252773.us-west-2.bonsaisearch.net"; // localhost or bonsai url
        String username = "aky9btiw5p"; // needed only for bonsai
        String password = "cabsmlarnb"; // needed only for bonsai
